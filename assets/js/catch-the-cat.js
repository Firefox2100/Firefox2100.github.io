    ...
    var k = function(t) {
        ...
        Object.defineProperty(e.prototype, "state", {
            ...
            set: function(t) {
                ...
                case i.PLAYING:
                    break;
                case i.LOSE:
                    this.setStatusText(f.default("You lost! The cat has escaped from the maze."));
                    break;
                case i.WIN:
                    this.setStatusText(f.default("You won! The cat is traped!"));
                    break;
                default:
                    return
                }
        ...
        e.prototype.playerClick = function(t, e) {
            ...
            this.state !== i.PLAYING)
                return this.setStatusText(f.default("Game over. Restart")),
                this.reset(),
                !1;
            var n = this.getBlock(t, e);
            return n ? n.isWall ? (this.setStatusText(f.default("This is already a wall. You can't click here.")),
            !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(f.default("This is the cat. You can't click here.")),
            !1) : (n.isWall = !0,
            this.cat.isCaught() ? (this.setStatusText(f.default("You won! The cat is traped!")),
            this.state = i.WIN,
            !1) : (this.setStatusText(f.default("You have clicked ") + "(" + t + ", " + e + ")"),
            this.cat.step() || (this.setStatusText(f.default("The cat gives up, you won!")),
            this.state = i.WIN),
            !0)) : (this.setStatusText(f.default("Error: this position does not exist.")),
            !1)
        }
        ,
        e.prototype.reset = function() {
            ...
            this.randomWall(),
            this.state = i.PLAYING,
            this.setStatusText(f.default("Click the dots and trap the cat."))
        }
        ,
...
, function(t, e, n) {
    ...
    var i = n(2)
      , s = function(t) {
        function e(e) {
            var n = t.call(this, e, 0, 0, i.default("Reset"), {}) || this;
            n.setColor("#000000");
            var o = e.r;
            n.setFontSize(o),
